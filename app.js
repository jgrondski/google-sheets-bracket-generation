...
const CREDENTIALS_PATH = process.env.CREDENTIALS_PATH || join(__dirname, 'oauth-credentials.json');
...
async function authorize(credentials, callback) {
  ...
  try {
    ...
    if (err.code === 'ENOENT' || (err.message && err.message.includes('invalid_grant'))) {
